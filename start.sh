...
/app/tailscale up --ssh --authkey=${TAILSCALE_AUTHKEY} --hostname=${KOYEB_APP_NAME} --advertise-routes=192.0.2.0/24,198.51.100.0/24,0.0.0.0/0,redis-germany-01.interesting-allianora.internal
