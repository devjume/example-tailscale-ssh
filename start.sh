...
/app/tailscale up --ssh --authkey=${TAILSCALE_AUTHKEY} --hostname="koyeb-${KOYEB_APP_NAME}-${KOYEB_SERVICE_NAME}" --advertise-exit-node --advertise-routes=10.3.0.0/16 --accept-dns=false 
